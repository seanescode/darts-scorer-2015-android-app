...
public final class AdOverlayInfoParcel implements SafeParcelable {
    ...
    AdOverlayInfoParcel(int versionCode, AdLauncherIntentInfoParcel adLauncherIntentInfo, IBinder wrappedAdClickListener, IBinder wrappedAdOverlayListener, IBinder wrappedAdWebView, IBinder wrappedAppEventGmsgListener, String baseUrl, boolean customClose, String html, IBinder wrappedLeaveApplicationListener, int orientation, int overlayType, String url, VersionInfoParcel versionInfo, IBinder wrappedInAppPurchaseGmsgListener, String debugMessage, InterstitialAdParameterParcel interstitialAdParameter) {
        ...
        this.zzEB = (com.google.android.gms.ads.internal.client.zza) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedAdClickListener));
        this.zzEC = (zzg) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedAdOverlayListener));
        this.zzED = (zzjp) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedAdWebView));
        this.zzEE = (zzdb) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedAppEventGmsgListener));
        this.zzEF = baseUrl;
        this.zzEG = customClose;
        this.zzEH = html;
        this.zzEI = (zzp) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedLeaveApplicationListener));
        this.orientation = orientation;
        this.zzEJ = overlayType;
        this.url = url;
        this.zzrl = versionInfo;
        this.zzEK = (zzdh) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedInAppPurchaseGmsgListener));
