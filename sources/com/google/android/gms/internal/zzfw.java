...
public interface zzfw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfw {
        ...
        private static class C0066zza implements zzfw {
        ...
        public static zzfw zzM(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfw)) ? new C0066zza(iBinder) : (zzfw) iInterfaceQueryLocalInterface;
        }
