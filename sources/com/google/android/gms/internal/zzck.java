...
public interface zzck extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzck {
        ...
        private static class C0044zza implements zzck {
        ...
        public static zzck zzv(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzck)) ? new C0044zza(iBinder) : (zzck) iInterfaceQueryLocalInterface;
        }
