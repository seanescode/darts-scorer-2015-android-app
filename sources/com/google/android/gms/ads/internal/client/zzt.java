...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C0005zza implements zzt {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder iBinderZza = zza(zzd.zza.zzbs(data.readStrongBinder()), data.readString(), zzex.zza.zzE(data.readStrongBinder()), data.readInt());
