...
public class zza {
    ...
    public static abstract class AbstractC0026zza<R extends Result, A extends Api.zzb> extends com.google.android.gms.common.api.internal.zzb<R> implements zzb<R>, zzj.zze<A> {
        private final Api.zzc<A> zzaeE;
        private AtomicReference<zzj.zzd> zzagH;

        protected AbstractC0026zza(Api.zzc<A> zzcVar, GoogleApiClient googleApiClient) {
