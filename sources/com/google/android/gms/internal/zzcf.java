...
public interface zzcf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcf {
        ...
        private static class C0041zza implements zzcf {
        ...
        public static zzcf zzs(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcf)) ? new C0041zza(iBinder) : (zzcf) iInterfaceQueryLocalInterface;
        }
