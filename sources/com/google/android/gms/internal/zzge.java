...
public interface zzge extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzge {
        ...
        private static class C0070zza implements zzge {
        ...
        public static zzge zzQ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzge)) ? new C0070zza(iBinder) : (zzge) iInterfaceQueryLocalInterface;
        }
