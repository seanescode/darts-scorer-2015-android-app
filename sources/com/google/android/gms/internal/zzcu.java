...
public interface zzcu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcu {
        ...
        private static class C0051zza implements zzcu {
        ...
        public static zzcu zzC(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcu)) ? new C0051zza(iBinder) : (zzcu) iInterfaceQueryLocalInterface;
        }
