...
public interface zzcs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcs {
        ...
        private static class C0049zza implements zzcs {
        ...
        public static zzcs zzA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcs)) ? new C0049zza(iBinder) : (zzcs) iInterfaceQueryLocalInterface;
        }
