...
public interface zzcr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcr {
        ...
        private static class C0048zza implements zzcr {
        ...
        public static zzcr zzz(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcr)) ? new C0048zza(iBinder) : (zzcr) iInterfaceQueryLocalInterface;
        }
