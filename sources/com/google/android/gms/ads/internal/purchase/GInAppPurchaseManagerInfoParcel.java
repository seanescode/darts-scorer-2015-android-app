...
public final class GInAppPurchaseManagerInfoParcel implements SafeParcelable {
    ...
    GInAppPurchaseManagerInfoParcel(int versionCode, IBinder wrappedInAppPurchaseVerifier, IBinder wrappedInAppPurchase, IBinder wrappedAppContext, IBinder wrappedOnPlayStorePurchaseFinishedListener) {
        ...
        this.zzrI = (zzk) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedInAppPurchaseVerifier));
        this.zzFw = (zzgc) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedInAppPurchase));
        this.zzFx = (Context) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedAppContext));
        this.zzFy = (zzj) com.google.android.gms.dynamic.zze.zzp(zzd.zza.zzbs(wrappedOnPlayStorePurchaseFinishedListener));
    }
