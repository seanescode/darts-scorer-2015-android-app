...
public interface zzlx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzlx {
        ...
        private static class C0075zza implements zzlx {
        ...
        public static zzlx zzaL(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzlx)) ? new C0075zza(iBinder) : (zzlx) iInterfaceQueryLocalInterface;
        }
