...
public interface zzly extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzly {
        ...
        private static class C0076zza implements zzly {
        ...
        public static zzly zzaM(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzly)) ? new C0076zza(iBinder) : (zzly) iInterfaceQueryLocalInterface;
        }
