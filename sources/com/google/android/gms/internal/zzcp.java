...
public interface zzcp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcp {
        ...
        private static class C0047zza implements zzcp {
        ...
        public static zzcp zzy(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcp)) ? new C0047zza(iBinder) : (zzcp) iInterfaceQueryLocalInterface;
        }
