...
public interface zzgg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgg {
        ...
        private static class C0072zza implements zzgg {
        ...
        public static zzgg zzS(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzgg)) ? new C0072zza(iBinder) : (zzgg) iInterfaceQueryLocalInterface;
        }
