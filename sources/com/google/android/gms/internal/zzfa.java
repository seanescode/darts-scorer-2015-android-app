...
public interface zzfa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfa {
        ...
        private static class C0062zza implements zzfa {
        ...
        public static zzfa zzH(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfa)) ? new C0062zza(iBinder) : (zzfa) iInterfaceQueryLocalInterface;
        }
