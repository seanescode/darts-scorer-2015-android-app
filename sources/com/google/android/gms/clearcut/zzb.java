...
public final class zzb {
    ...
    public class zza {
        ...
        private String zzaeV;
        private int zzaeX;
        private final InterfaceC0025zzb zzafb;
        private InterfaceC0025zzb zzafc;
        private ArrayList<Integer> zzafd;
        private final zzsz.zzd zzafe;
        private boolean zzaff;

        private zza(zzb zzbVar, byte[] bArr) {
            this(bArr, (InterfaceC0025zzb) null);
        }

        private zza(byte[] bArr, InterfaceC0025zzb interfaceC0025zzb) {
