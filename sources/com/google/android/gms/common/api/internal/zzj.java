...
public final class zzj extends GoogleApiClient implements zzp.zza {
    ...
    final Queue<zza.AbstractC0026zza<?, ?>> zzahN = new LinkedList();
    ...
    public void disconnect() {
        ...
        try {
            ...
            this.zzahV.clear();
            for (zza.AbstractC0026zza<?, ?> abstractC0026zza : this.zzahN) {
                abstractC0026zza.zza((zzd) null);
                abstractC0026zza.cancel();
            }
            this.zzahN.clear();
            if (this.zzahM == null) {
                return;
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public <A extends Api.zzb, R extends Result, T extends zza.AbstractC0026zza<R, A>> T zza(@NonNull T t) {
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public <A extends Api.zzb, T extends zza.AbstractC0026zza<? extends Result, A>> T zzb(@NonNull T t) {
        ...
        try {
            ...
            if (zzpB()) {
                ...
                while (!this.zzahN.isEmpty()) {
                    zza.AbstractC0026zza<?, ?> abstractC0026zzaRemove = this.zzahN.remove();
                    zzb((zze) abstractC0026zzaRemove);
                    abstractC0026zzaRemove.zzw(Status.zzagE);
                }
            } else {
