...
public interface zzgf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgf {
        ...
        private static class C0071zza implements zzgf {
        ...
        public static zzgf zzR(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzgf)) ? new C0071zza(iBinder) : (zzgf) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder iBinderZzf = zzf(zzd.zza.zzbs(data.readStrongBinder()));
