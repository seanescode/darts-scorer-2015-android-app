...
public class zzgx implements zzgw.zza<com.google.android.gms.ads.internal.formats.zzd> {
    ...
    public com.google.android.gms.ads.internal.formats.zzd zza(zzgw zzgwVar, JSONObject jSONObject) throws ExecutionException, JSONException, InterruptedException {
        ...
        return new com.google.android.gms.ads.internal.formats.zzd(jSONObject.getString("headline"), arrayList, jSONObject.getString("body"), zzjgVarZza.get(), jSONObject.getString("call_to_action"), jSONObject.optDouble("rating", -1.0d), jSONObject.optString("store"), jSONObject.optString("price"), zzjgVarZzf.get(), new Bundle());
    }
}
