...
public interface zzgh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgh {
        ...
        private static class C0073zza implements zzgh {
        ...
        public static zzgh zzT(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzgh)) ? new C0073zza(iBinder) : (zzgh) iInterfaceQueryLocalInterface;
        }
