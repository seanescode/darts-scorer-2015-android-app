...
public interface zzcl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcl {
        ...
        private static class C0045zza implements zzcl {
        ...
        public static zzcl zzw(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcl)) ? new C0045zza(iBinder) : (zzcl) iInterfaceQueryLocalInterface;
        }
