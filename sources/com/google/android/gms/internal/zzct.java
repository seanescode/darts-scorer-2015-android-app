...
public interface zzct extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzct {
        ...
        private static class C0050zza implements zzct {
        ...
        public static zzct zzB(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzct)) ? new C0050zza(iBinder) : (zzct) iInterfaceQueryLocalInterface;
        }
