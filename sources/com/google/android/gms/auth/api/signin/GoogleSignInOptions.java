...
public class GoogleSignInOptions implements Api.ApiOptions.Optional, SafeParcelable {
    ...
    public static final class Builder {
        ...
        public Builder setAccountName(String accountName) {
            this.zzTI = new Account(zzx.zzcM(accountName), com.google.android.gms.auth.zzd.GOOGLE_ACCOUNT_TYPE);
            return this;
        }
    ...
    public static GoogleSignInOptions zzbJ(@Nullable String str) throws JSONException {
        ...
        return new GoogleSignInOptions(hashSet, !TextUtils.isEmpty(strOptString) ? new Account(strOptString, com.google.android.gms.auth.zzd.GOOGLE_ACCOUNT_TYPE) : null, jSONObject.getBoolean("idTokenRequested"), jSONObject.getBoolean("serverAuthRequested"), jSONObject.getBoolean("forceCodeForRefreshToken"), jSONObject.optString("serverClientId", null), jSONObject.optString("hostedDomain", null));
    }
