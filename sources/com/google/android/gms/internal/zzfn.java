...
public class zzfn extends zzfs {
    ...
    private void zzh(Map<String, String> map) {
        if (!TextUtils.isEmpty(map.get("width"))) {
            this.zzoG = com.google.android.gms.ads.internal.zzr.zzbC().zzaD(map.get("width"));
        }
        if (!TextUtils.isEmpty(map.get("height"))) {
            this.zzoH = com.google.android.gms.ads.internal.zzr.zzbC().zzaD(map.get("height"));
        }
    ...
    public void zzi(Map<String, String> map) {
        ...
        synchronized (this.zzpV) {
            ...
            layoutParams = new RelativeLayout.LayoutParams(com.google.android.gms.ads.internal.client.zzn.zzcS().zzb(this.zzDh, 50), com.google.android.gms.ads.internal.client.zzn.zzcS().zzb(this.zzDh, 50));
            switch (this.zzDb) {
                case "top-left":
