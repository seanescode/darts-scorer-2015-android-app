...
public interface zzml extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzml {
        ...
        private static class C0078zza implements zzml {
        ...
        public static zzml zzaY(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzml)) ? new C0078zza(iBinder) : (zzml) iInterfaceQueryLocalInterface;
        }
