...
public interface zzex extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzex {
        ...
        private static class C0059zza implements zzex {
        ...
        public static zzex zzE(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzex)) ? new C0059zza(iBinder) : (zzex) iInterfaceQueryLocalInterface;
        }
